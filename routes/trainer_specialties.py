...
def list():
    ...
    return render_template('trainer_specialties/trainer_specialties/list.html', trainer_specialties=specialties)
...
def add():
    ...
    return render_template('trainer_specialties/trainer_specialties/form.html', specialty=None)
...
def edit(specialty_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('trainer_specialties.list'))
    return render_template('trainer_specialties/trainer_specialties/form.html', specialty=specialty)
