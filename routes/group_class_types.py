...
def list():
    ...
    return render_template('group_class_types/group_class_types/list.html', group_class_types=types)
...
def add():
    ...
    return render_template('group_class_types/group_class_types/form.html', group_class_type=None)
...
def edit(type_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('group_class_types.list'))
    return render_template('group_class_types/group_class_types/form.html', group_class_type=group_class_type)
