...
def list():
    ...
    return render_template('membership_types/membership_types/list.html', membership_types=membership_types)
...
def add():
    ...
    return render_template('membership_types/membership_types/form.html', membership_type=None)
...
def edit(type_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('membership_types.list'))
    return render_template('membership_types/membership_types/form.html', membership_type=membership_type)
