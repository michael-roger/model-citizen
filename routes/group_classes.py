...
def list():
    ...
    return render_template('group_classes/../templates/group_classes/list.html', group_classes=classes)
...
def add():
    ...
    return render_template('group_classes/../templates/group_classes/form.html', group_class=None, types=types, gyms=gyms, trainers=trainers,
...
def edit(class_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('group_classes.list'))
    return render_template('group_classes/../templates/group_classes/form.html', group_class=group_class, types=types, gyms=gyms, trainers=trainers,
